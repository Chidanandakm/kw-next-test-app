      ...
      <main className="mt-10">
        <div className="mb-4 md:mb-0 w-full mx-auto relative">
          <div className="px-4 lg:px-0">
            <h2 className="text-4xl font-semibold text-white-800 leading-tight">
              {data?.title}
            </h2>
            <a
              href="#"
          ...
          <Image
            ...
            height={100}
            alt=""
            src={`http://localhost:8000/media/original_images/ferdinand-stohr-149422.jpg`}
            className="w-full object-cover lg:rounded"
          />
        </div>

        <div className="flex flex-col lg:flex-row lg:space-x-12">
          <div className="px-4 lg:px-0 mt-12 text-white-700 text-lg leading-relaxed w-full lg:w-3/4">
            <p
              className="pb-6"
          ...
          <div className="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
            <div className="p-4 border-t border-b md:border md:rounded">
              <div className="flex py-2">
                ...
                />
                <div>
                  <p className="font-semibold text-white-700 text-sm">
                    {" "}
                    Mike Sullivan{" "}
                  </p>
                  <p className="font-semibold text-white-600 text-xs">
                    {" "}
                    Editor{" "}
                  </p>
                </div>
              </div>
              <p className="text-white-700 py-3">
...
export const getStaticProps = async ({ params: { id } }) => {
  try {
    const res = await axios.get(`http://127.0.0.1:8000/api/v2/pages/12/`);
    console.log(res);
